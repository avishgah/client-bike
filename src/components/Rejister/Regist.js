          ...
          <Typography variant="h5" component="div">
            פרטים אישיים
                ...
                <LocalizationProvider  dateAdapter={AdapterDayjs} >
                    <DemoContainer sx={{marginLeft:'39vw'}} components={['DatePicker']} {...register("date", { required: true })}>
                        <DatePicker sx={{width:'35vw'}} value={value} onChange={(newValue) => setValue(newValue)} />
                    </DemoContainer>
