        ...
        <div style={{ direction: 'rtl', width: "70vw", textAlign: "right", marginLeft: "15vw"}}>
            <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
                <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
                    <Typography className="tyQuestion" sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>מדוע עליי לסרוק תעודה מזהה בעת הרישום הראשוני באתר?</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
                <AccordionSummary aria-controls="panel2d-content" id="panel2d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>כמה זוגות אופניים ניתן לשכור ולשחרר באמצעות האתר?</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
                <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>באילו כרטיסי אשראי ניתן להשתמש ולשלם עבור שירותי פדאל?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane14'} onChange={handleChange('pane14')}>
                <AccordionSummary aria-controls="pane14d-content" id="pane14d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>כיצד ניתן לעדכן פרטים אישיים ופרטי אשראי?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane15'} onChange={handleChange('pane15')}>
                <AccordionSummary aria-controls="pane15d-content" id="pane15d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>כיצד אוכל לעקוב אחר החיובים והרכיבות שביצעתי?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane16'} onChange={handleChange('pane16')}>
                <AccordionSummary aria-controls="pane16d-content" id="pane16d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>האם בעת ההשכרה נלקח ערבון כלשהו?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane17'} onChange={handleChange('pane17')}>
                <AccordionSummary aria-controls="pane17d-content" id="pane17d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>כיצד ניתן למחוק חשבון?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane18'} onChange={handleChange('pane18')}>
                <AccordionSummary aria-controls="pane18d-content" id="pane18d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>מי רשאי להשתמש בשירות האופניים החשמליים?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane19'} onChange={handleChange('pane19')}>
                <AccordionSummary aria-controls="pane19d-content" id="pane19d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>כיצד משחררים ומחזירים אופניים בתחנות?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane20'} onChange={handleChange('pane20')}>
                <AccordionSummary aria-controls="pane20d-content" id="pane20d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>מה עליי לעשות אם האופניים ששחררתי תקולים או אם ארעה תקלה באמצע הדרך?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane21'} onChange={handleChange('pane21')}>
                <AccordionSummary aria-controls="pane21d-content" id="pane21d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>כיצד ניתן לדווח על אופניים תקולים או נטושים?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane22'} onChange={handleChange('pane22')}>
                <AccordionSummary aria-controls="pane22d-content" id="pane22d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>האופניים נגנבו לי, מה עליי לעשות?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane23'} onChange={handleChange('pane23')}>
                <AccordionSummary aria-controls="pane23d-content" id="pane23d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>אפשר לקבל מידע על המפרט הטכני של האופניים?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane24'} onChange={handleChange('pane24')}>
                <AccordionSummary aria-controls="pane24d-content" id="pane24d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>האם עליי לחבוש קסדה בזמן הרכיבה?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane25'} onChange={handleChange('pane25')}>
                <AccordionSummary aria-controls="pane25d-content" id="pane25d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>האם אני מבוטח/ת דרך שירות פדאל בעת הרכיבה?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane26'} onChange={handleChange('pane26')}>
                <AccordionSummary aria-controls="pane26d-content" id="pane26d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>האם ניתן להרכיב אדם נוסף או ילד על האופניים?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane27'} onChange={handleChange('pane27')}>
                <AccordionSummary aria-controls="pane27d-content" id="pane27d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>היכן ממוקמות תחנות פדאל?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane28'} onChange={handleChange('pane28')}>
                <AccordionSummary aria-controls="pane28d-content" id="pane28d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>מה קורה אם אין אופניים זמינים בתחנה?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane29'} onChange={handleChange('pane29')}>
                <AccordionSummary aria-controls="pane29d-content" id="pane29d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>מה עלי לעשות אם אני רוצה להחזיר אופניים והתחנה מלאה?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
            ...
            <Accordion expanded={expanded === 'pane30'} onChange={handleChange('pane30')}>
                <AccordionSummary aria-controls="pane30d-content" id="pane30d-header">
                    <Typography sx={{fontSize:"20px",color:"#4c809e",fontWeight:"bold"}}>אני רוצה להציע מיקום נוסף לתחנת פדאל.
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
